    ...
    <q-card>
      <q-card-section>
        <div class="MainText">
          ...
          <p align="left">
            <a href="http://copyright.ru/" title="©">©</a> Дмитрий Малахов, 2021
            <a href="/?file=410" title="Пользовательское соглашение"
          ...
          <p style="text-align: center; line-height: normal" align="center">
            <b><span>Пользовательское соглашение</span></b>
          </p>
          <p
            style="margin-bottom: 0.0001pt; text-align: justify; text-indent: 35.45pt; line-height: normal"
          >
            <span
              >Настоящее Соглашение определяет условия использования
              Пользователями материалов и сервисов сайта </span
            ><a :href="siteURL"
              ><span>{{ siteURL }}</span
              ><span>.</span></a
            ><span
          ...
          <p>
            ...
            к материалам Сайта Пользователь считается присоединившимся к
          ...
          <p>
            ...
            <a
              ...
              title="интеллектуальной собственности"
          ...
          <p>
            ...
            на Сайт обязательна (подпункт 1 пункта 1 статьи 1274&nbsp;Г.К РФ).
          </p>
          <p>
          ...
          <p>
            ...
            или убытками, связанными с любым содержанием Сайта,
            <u
              ><a
                href="http://copyright.ru/ru/documents/registraciy_avtorskih_prav/"
                title="регистрацией авторских прав"
                >регистрацией авторских прав</a
              ></u
            >
            и сведениями о такой регистрации, товарами или услугами, доступными
            на или полученными через внешние сайты или ресурсы либо иные
            контакты Пользователя, в которые он вступил, используя размещенную
          ...
          <p>
            ...
            действия в защиту своих интересов и
            <a
              href="http://copyright.ru/documents/zashita_avtorskih_prav/"
              title="защиту авторских прав"
          ...
          <p>
            <b
              ...
              настоящего Соглашения и безусловно принимает их.</b
            >
          </p>
        </div>
      </q-card-section>
